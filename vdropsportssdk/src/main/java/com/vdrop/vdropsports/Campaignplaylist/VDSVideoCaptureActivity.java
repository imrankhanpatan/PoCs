...
import com.vdrop.vdropsports.utils.VDSCameraPreview;

import java.io.File;
import java.io.IOException;

public class VDSVideoCaptureActivity extends AppCompatActivity {

    private Camera mCamera;
    private VDSCameraPreview mPreview;
    ...
    private ImageView vdsIVRecordCancel;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vdsvideo_capture);
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        myContext = this;
        mTimerTv = (TextView) findViewById(R.id.tvTimer);
        vdsIVRecordCancel=(ImageView)findViewById(R.id.vds_record_cancel);
        vdsIVRecordCancel.setOnClickListener(new OnClickListener() {
            @Override
    ...
    public void initialize() {
        ...
        mPreview = new VDSCameraPreview(myContext, mCamera);
    ...
    OnClickListener captrureListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (recording) {
                ...
                Toast.makeText(VDSVideoCaptureActivity.this, "Video captured!", Toast.LENGTH_LONG).show();
                recording = false;
                capture.setSelected(true);

            } else {
                if (!prepareMediaRecorder()) {
                    Toast.makeText(VDSVideoCaptureActivity.this, "Fail in prepareMediaRecorder()!\n - Ended -", Toast.LENGTH_LONG).show();
                    finish();
                }
    ...
    private boolean prepareMediaRecorder() {
        ...
        mediaRecorder.setOrientationHint(VDSCameraPreview.rotate);

        mediaRecorder.setProfile(CamcorderProfile.get(CamcorderProfile.QUALITY_LOW));

        mediaRecorder.setOutputFile(filePath);
        mediaRecorder.setMaxDuration(30000); // Set max duration 15 sec.
    ...
    private void requestCameraPermission() {
        ...
        ActivityCompat.requestPermissions(VDSVideoCaptureActivity.this, permissions,
    ...
    public static void openVideoActivity(Activity activity) {
        Intent intent = new Intent(activity, VDSVideoCaptureActivity.class);
